...
<main>
                    <div class="container-fluid px-4 main">
                        ...
                        <h1 class="mt-4">Main Page edit</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item active">Edit Page</li>
                        </ol>

                        <form action="{{ route('list.update',$main->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-4">
                                    <div>
                                        <h3>Image</h3>
                                        <img src="{{ url($main->main_image) }}" alt=""  class="img-thumbnail" id="prevImage" style="height: 30vh">
